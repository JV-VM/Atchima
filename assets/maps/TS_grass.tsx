...
<tileset version="1.10" tiledversion="1.12.1" name="TS_grass" tilewidth="64" tileheight="64" tilecount="15" columns="5">
 <image source="../tilesets/tilesets/grass/TS_grass.png" width="320" height="192"/>
 <wangsets>
  <wangset name="grass_terrain" type="corner" tile="-1">
